        ...
        <div class="card-body">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <span class="fs-18">Total Invoices</span> </div>
        ...
        <div class="card-body">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <span class="fs-18">Paid Invoices</span> </div>
            <span class="p-3 border ml-3 rounded-circle">
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="card-body">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <span class="fs-18">Total Unpaid Invoices</span> </div>
            <span class="p-3 border ml-3 rounded-circle">
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <table class="table display mb-4 dataTablesCard " id="example-5">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="text-black font-w500">#123412451</span></td>
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td><div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/19.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black font-w500">#123412451</span></td>
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td><div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/26.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black font-w500">#123412451</span></td>
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td><div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/21.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black font-w500">#123412451</span></td>
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td><div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/24.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
